...
const RotateGlowingBorder = ({ circleSize, children }: rotateGlowingBorderProps) => {
  return (
    <div
      className='relative flex items-center justify-center rounded-full bg-(--countdown-bg) p-16'
    ...
    >
      <div
        ...
        style={{
          ...
          background:
            'linear-gradient(45deg, var(--countdown-border-1), var(--countdown-border-2), var(--countdown-border-3), var(--countdown-border-4))',
